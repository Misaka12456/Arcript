...
namespace SFB {
    ...
    public class StandaloneFileBrowser {
        ...
        {
            var array = _platformWrapper.OpenFilePanel(title, directory, extensions, multiselect);
            return array.Any() ? array[0] : null;
        }
        ...
        {
            var array = _platformWrapper.OpenFolderPanel(title, directory, multiselect);
            return array.Any()? array[0] : null;
        }
